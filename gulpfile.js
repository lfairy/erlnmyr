...
buildTask('perf', [{name: 'input', options: {data: options.url}}, {name: 'trace', options: {browser: options.perfBrowser}}, 'jsonStringify', {name: 'writeStringFile', options: {filename: 'trace.json'}}]);
